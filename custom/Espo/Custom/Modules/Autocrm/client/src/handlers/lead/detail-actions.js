define('autocrm:handlers/lead/detail-actions', ['view'], function (Dep) {
    ...
    return Dep.extend({
        ...
        findContacts: function () {
            ...
            this.ajaxPostRequest('Lead/action/findContacts', {id: leadId})
                .then((response) => {
        ...
        isFindContactsAvailable: function () {
            ...
            return this.model.has('emailAddress') && this.model.get('emailAddress');
        }
